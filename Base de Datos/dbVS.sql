...
-- -----------------------------------------------------
-- Table `dbVS`.`suplidores`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbVS`.`suplidores` (
...
-- -----------------------------------------------------
-- Table `dbVS`.`empleados`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbVS`.`empleados` (
...
-- -----------------------------------------------------
-- Table `dbVS`.`materiasPrimas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbVS`.`materiasPrimas` (
...
-- Table `dbVS`.`cigarros`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbVS`.`cigarros` (
  ...
  CONSTRAINT `fk_cigarro_materiaPrima1`
    ...
    REFERENCES `dbVS`.`materiasPrimas` (`idmateriaPrima`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `dbVS`.`configuraciones`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbVS`.`configuraciones` (
  ...
  CONSTRAINT `fk_configuracion_cigarro1`
    ...
    REFERENCES `dbVS`.`cigarros` (`idcigarro`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `dbVS`.`maquinas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbVS`.`maquinas` (
...
-- -----------------------------------------------------
-- Table `dbVS`.`produccion_maquinas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbVS`.`produccion_maquinas` (
  ...
  CONSTRAINT `fk_produccion_maquina_configuracion1`
    ...
    REFERENCES `dbVS`.`configuraciones` (`idconfiguracion`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  ...
  CONSTRAINT `fk_produccion_maquina_maquina1`
    ...
    REFERENCES `dbVS`.`maquinas` (`idmaquina`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `dbVS`.`tipo_users`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbVS`.`tipo_users` (
...
-- Table `dbVS`.`users`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbVS`.`users` (
  ...
  CONSTRAINT `fk_usuario_tipo_usuario1`
    ...
    REFERENCES `dbVS`.`tipo_users` (`idtipo_usuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `dbVS`.`entradas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbVS`.`entradas` (
  ...
  CONSTRAINT `fk_suplidor_has_materiaPrima_suplidor1`
    ...
    REFERENCES `dbVS`.`suplidores` (`idsuplidor`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- Table `dbVS`.`salidas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbVS`.`salidas` (
  `materiaPrima_idmateriaPrima` INT NOT NULL,
  `cantidad` DECIMAL(11,2) NULL,
...
-- Table `dbVS`.`jornadas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbVS`.`jornadas` (
  `maquina_idmaquina` INT NOT NULL,
  ...
  CONSTRAINT `fk_maquina_has_empleado_empleado1`
    ...
    REFERENCES `dbVS`.`empleados` (`idempleado`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
