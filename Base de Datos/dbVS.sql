...
CREATE TABLE IF NOT EXISTS `dbVS`.`materiaPrima` (
  ...
  `porcentaje_pesohumedo` FLOAT NULL,
  `existencia_minima` FLOAT NULL,
  `existencia_real` FLOAT NULL,
...
-- -----------------------------------------------------
-- Table `dbVS`.`produccion_maquina`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbVS`.`produccion_maquina` (
...
-- -----------------------------------------------------
-- Table `dbVS`.`tipo_usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbVS`.`tipo_usuario` (
...
-- Table `dbVS`.`usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbVS`.`usuario` (
  ...
  CONSTRAINT `fk_usuario_tipo_usuario1`
    ...
    REFERENCES `dbVS`.`tipo_usuario` (`idtipo_usuario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `dbVS`.`nomina`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbVS`.`nomina` (
  `nominaEmpleado_idnominaEmpleado` INT NOT NULL,
  `empleado_idempleado` INT NOT NULL,
  `salario` FLOAT NULL,
  `incentivo` FLOAT NULL,
  `licencia` FLOAT NULL,
  `hora_extra` FLOAT NULL,
  `salario_bruto` FLOAT NULL,
  `seguro` FLOAT NULL,
  `prestamo_oficina` FLOAT NULL,
  `tss_pc` FLOAT NULL,
  `tss` FLOAT NULL,
  `afs` FLOAT NULL,
  `agua` FLOAT NULL,
  `comida` FLOAT NULL,
  `prestamo_raf` FLOAT NULL,
  `descuento` FLOAT NULL,
  `neto` FLOAT NULL,
  PRIMARY KEY (`nominaEmpleado_idnominaEmpleado`),
