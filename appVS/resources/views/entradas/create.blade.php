<div class="right_col" role="main">
  <!--<div class="">-->
    ...
    <form class="form-horizontal" method="post" action="/entradas">
      ...
      <h3>   <button  class="btn btn-primary btn btn-xs" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="fa fa-user-plus" aria-hidden="true"></i> Crear Entrada</button></h3>
