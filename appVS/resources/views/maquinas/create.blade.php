  ...
  <div class="right_col" role="main">
    ...
    <form class="form-horizontal" method="post" action="/maquinas">
      ...
      <h3>   <button  class="btn btn-primary btn btn-xs" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="fa fa-plus-circle" aria-hidden="true"></i> Crear Maquina</button></h3>
