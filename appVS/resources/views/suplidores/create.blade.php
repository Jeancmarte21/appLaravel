   ...
   <form method = "get" action = "{{route ('suplidores.store') }}">
    ...
    <div class="form-group"> 
        ...
        <span class="col-md-1 col-md-offset-2 text-center"><label for="full_name_id" class="control-label">Empresa</label></span>
         <div class="col-md-8">
        <input type="text" class="form-control" id="nombre" name="full_name" placeholder="John Deer"></div>
    </div>  
    ...
    <div class="form-group">
     ...
     <div class="form-group">
                           <span class="col-md-1 col-md-offset-2 text-center"> <label for="full_name_id" class="control-label">Direccion</label></span>
                            <div class="col-md-8">
                                <input id="direccion" name="Address" type="Address" placeholder="Apartment, suite, unit, building, floor, etc." class="form-control">
                            </div>
                        </div>                  
                            ...
                            <div class="col-md-8">
                                <input id="correo" name="email" type="text" placeholder="@ejemplo.com" class="form-control">
                            </div>
                        </div>
